        ...
        <li>
          <LongButton
            ...
            onClick={() => {
              ...
              location.href = `https://kauth.kakao.com/oauth/authorize?client_id=${client_id}&redirect_uri=http://${process.env.REACT_APP_HOST_KEY}/login/kakao&response_type=code`;
            }}
          >
            카카오로 계속하기
          </LongButton>
